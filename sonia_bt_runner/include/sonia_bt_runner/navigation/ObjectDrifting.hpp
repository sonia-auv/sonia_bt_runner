...
#define OBJECT_DRIFTING_DETECTION "Detection"
#define OBJECT_DRIFTING_DETECTION_TYPE AiDetection

#define OBJECT_DRIFTING_TRAJECTORY "Trajectory"
    ...
    class ObjectDrifting : public BT::SyncActionNode
    {
        public:
            ...
            static BT::PortsList providedPorts()
            {
                return {
                    // Inputs
                    BT::InputPort<OBJECT_DRIFTING_DETECTION_TYPE>(OBJECT_DRIFTING_DETECTION),

                    // Outputs
                    BT::BidirectionalPort<OBJECT_DRIFTING_TRAJECTORY_TYPE>(OBJECT_DRIFTING_TRAJECTORY),
                };
            }
